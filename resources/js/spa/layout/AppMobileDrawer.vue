<template>
    <div>
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-80 max-w-[92vw] app-surface border-r-0 transform transition-transform duration-300 lg:hidden"
            ...
            <div class="p-4 border-b border-secondary-200/70 dark:border-secondary-700/70 app-surface-soft">
            ...
            <div class="p-4 border-t border-secondary-200/70 dark:border-secondary-700/70 [padding-bottom:calc(1rem+env(safe-area-inset-bottom))]">
