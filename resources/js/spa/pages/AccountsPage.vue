    ...
    <section class="app-page-frame">
        ...
        <div v-if="activeTab === 'accounts'" class="min-h-0 flex flex-1 flex-col">
            <div class="app-page-scroll">
                <div class="app-surface rounded-2xl overflow-hidden">
                    ...
                    <article v-for="account in filteredAccounts" :key="account.id" class="p-4 space-y-2 cursor-pointer hover:bg-secondary-50 dark:hover:bg-secondary-800/40 transition-colors" @click="router.push('/accounts/' + account.id)">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-secondary-200 dark:divide-secondary-700">
                            <tr v-for="account in filteredAccounts" :key="account.id" class="hover:bg-secondary-50 dark:hover:bg-secondary-800/50 align-top cursor-pointer" @click="router.push('/accounts/' + account.id)">
                            ...
                            <tr v-if="filteredAccounts.length === 0">
                                <td colspan="3" class="px-6 py-10 text-center text-sm text-secondary-500 dark:text-secondary-400">No accounts found.</td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
        ...
        <div v-if="activeTab === 'transfers'" class="min-h-0 flex flex-1 flex-col">
            <div class="app-page-scroll">
                <div class="app-surface rounded-2xl overflow-hidden">
                    <div class="md:hidden divide-y divide-secondary-200 dark:divide-secondary-700">
                    <article v-for="transfer in filteredTransfers" :key="transfer.id" class="p-4 space-y-2 cursor-pointer hover:bg-secondary-50 dark:hover:bg-secondary-800/40 transition-colors" @click="router.push('/accounts/transfers/' + transfer.id)">
                        <div class="flex items-start justify-between gap-3">
                            <div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-secondary-200 dark:divide-secondary-700">
                            <tr v-for="transfer in filteredTransfers" :key="transfer.id" class="hover:bg-secondary-50 dark:hover:bg-secondary-800/50 align-top cursor-pointer" @click="router.push('/accounts/transfers/' + transfer.id)">
                            ...
                            <tr v-if="filteredTransfers.length === 0">
                                <td colspan="5" class="px-6 py-10 text-center text-sm text-secondary-500 dark:text-secondary-400">No transfers found.</td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
