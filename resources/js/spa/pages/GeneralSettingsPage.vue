        ...
        <div class="app-page-scroll">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="app-surface rounded-2xl p-4 md:p-6 flex flex-col items-center gap-4">
                    <h3 class="text-sm font-semibold text-secondary-700 dark:text-secondary-300 uppercase tracking-wide self-start">Logo</h3>
                    ...
                    <div class="w-32 h-32 rounded-xl overflow-hidden bg-secondary-100 dark:bg-secondary-800 flex items-center justify-center shrink-0 border border-secondary-200 dark:border-secondary-700">
                        <img v-if="logoUrl" :src="logoUrl" alt="Fitness center logo" class="w-full h-full object-contain" />
                    ...
                    <p class="text-xs text-secondary-400 dark:text-secondary-500 text-center">JPG, PNG, WebP or SVG · Max 2 MB</p>
                </div>
                    ...
                    <form class="app-surface rounded-2xl p-4 md:p-6" @submit.prevent="submit">
                        ...
                        <template v-else>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <AppFormField label="Fitness Center Name" class="md:col-span-2" :required="true">
                                    <AppFormInput v-model="form.name" type="text" required maxlength="255" placeholder="e.g. Iron Gym Colombo" />
                                </AppFormField>

                                <AppFormField label="Email Address" :optional="true">
                                    <AppFormInput v-model="form.email" type="email" maxlength="255" placeholder="info@example.com" />
                                </AppFormField>

                                <AppFormField label="Contact Number" :optional="true">
                                    <AppFormInput v-model="form.phone" type="tel" maxlength="50" placeholder="+94 77 123 4567" />
                                </AppFormField>

                                <AppFormField label="Address" class="md:col-span-2" :optional="true">
                                    <AppFormTextarea v-model="form.address" rows="3" maxlength="500" placeholder="Street, City, Country" />
                                </AppFormField>
                            </div>
