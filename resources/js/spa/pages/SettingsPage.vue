<template>
    <section class="app-page-frame">
        <AppPageHeader>
            <template #cta-slot>
                <AppHeaderAction v-if="activeTab === 'users' && userPermissions.create" to="/users/new" :icon="UserPlus" label="Add User" />
                <AppHeaderAction v-else-if="activeTab === 'roles' && allowRoleCreate" to="/roles/new" :icon="ShieldPlus" label="Add Role" />
            </template>
