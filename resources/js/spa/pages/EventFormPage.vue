<template>
  <section class="app-page-frame">
    ...
    <div class="app-page-scroll">
      <div v-if="loadingEvent" class="p-6 text-sm text-secondary-500 dark:text-secondary-400">
        Loading...
      </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                maxlength="255"
                class="app-form-input w-full"
                placeholder="e.g. Main Hall, City Sport Center"
              />
            </div>
            <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p class="mt-1 text-xs text-secondary-400">
                Main registrant ticket fee. Set to 0 for a free event.
              </p>
            </div>
            ...
            <div>
              ...
              <p class="mt-1 text-xs text-secondary-400">
                Fee charged per additional family member added to a registration.
              </p>
            </div>
          </div>
        </div>
