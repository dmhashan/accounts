      ...
      <template v-else>
        ...
        <div v-if="activeRoleId" class="space-y-4">
          ...
          <div class="app-surface rounded-2xl p-5 md:p-6 space-y-4">
            ...
            <div v-if="accounts.length === 0" class="text-sm text-secondary-500 dark:text-secondary-400">
          ...
          <p v-if="savedMessage" class="text-sm text-green-600 dark:text-green-400 text-right">
            {{ savedMessage }}
          </p>
        </div>
      </template>
