        ...
        <div class="min-h-0 flex flex-1 flex-col">
            <div class="app-page-scroll">
                ...
                <div class="md:hidden divide-y divide-secondary-200 dark:divide-secondary-700">
                    <article v-for="sale in filteredSales" :key="sale.id" class="p-4 space-y-2.5 hover:bg-secondary-50 dark:hover:bg-secondary-800/40 transition-colors cursor-pointer" @click="router.push('/sales/' + sale.id)">
                ...
                <div class="hidden md:block app-table-scroll">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-secondary-200 dark:divide-secondary-700">
                            <tr v-for="sale in filteredSales" :key="sale.id" class="app-table-row cursor-pointer" @click="router.push('/sales/' + sale.id)">
