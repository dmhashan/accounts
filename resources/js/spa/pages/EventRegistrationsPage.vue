<template>
    <section class="app-page-frame">
        <AppPageHeader :show-back="true" :title="event.name ? `${event.name} — Registrations` : 'Registrations'" />
            ...
            <div class="overflow-y-auto flex-1 px-5 py-4 space-y-4">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <button type="button" class="text-xs font-semibold text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300" @click="addRegGuest">+ Add</button>
                    </div>
