  ...
  <section class="max-w-6xl mx-auto space-y-4 md:space-y-5">
    <div class="app-surface rounded-2xl p-4 sm:p-5 md:p-6">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          <p class="text-[11px] uppercase tracking-[0.12em] text-secondary-500 dark:text-secondary-400">
            Profile
          </p>
          ...
          <p class="text-sm text-secondary-500 dark:text-secondary-400">
            View your account and linked member details.
          </p>
        </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-4 md:gap-5">
          ...
          <div class="min-w-0">
            ...
            <p class="text-sm text-primary-100 truncate">
              {{ member?.biometric_member_id || 'No linked member ID' }}
            </p>
          ...
          <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-5">
            <article class="app-surface-soft rounded-xl p-4 md:p-5">
              ...
              <dl class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div>
                  <dt class="text-secondary-500 dark:text-secondary-400">
                    Email
                  </dt>
                  <dd class="mt-1 text-secondary-900 dark:text-white break-all">
                    {{ member?.email || account.email || 'Not provided' }}
                  </dd>
                </div>
                <div>
                  <dt class="text-secondary-500 dark:text-secondary-400">
                  ...
                  <dd class="mt-1 text-secondary-900 dark:text-white">
                    {{ member?.username || account.username || 'Not provided' }}
                  </dd>
                </div>
                <div>
                  <dt class="text-secondary-500 dark:text-secondary-400">
            ...
            <article class="app-surface-soft rounded-xl p-4 md:p-5">
              ...
              <dl class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <dd class="mt-1 text-secondary-900 dark:text-white">
                    {{ member?.biometric_member_id || 'Not provided' }}
                  </dd>
                </div>
                <div>
                  <dt class="text-secondary-500 dark:text-secondary-400">
                  ...
                  <dd class="mt-1 text-secondary-900 dark:text-white">
                    {{ member?.member_role || 'Not provided' }}
                  </dd>
                </div>
                <div>
                  <dt class="text-secondary-500 dark:text-secondary-400">
                  ...
                  <dd class="mt-1 text-secondary-900 dark:text-white">
                    {{ member?.payment_plan || 'Not provided' }}
                  </dd>
                </div>
                <div>
                  <dt class="text-secondary-500 dark:text-secondary-400">
            ...
            <article v-if="member?.comment" class="app-surface-soft rounded-xl p-4 md:p-5 xl:col-span-2">
              <h3 class="text-sm font-semibold text-secondary-900 dark:text-white mb-2">
                Notes
              </h3>
