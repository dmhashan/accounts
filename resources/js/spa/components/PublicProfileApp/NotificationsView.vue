<template>
    <div>
        ...
        <div class="pt-12 pb-6">
            <h1 class="text-2xl font-bold text-gray-900 leading-tight tracking-tight">Notifications</h1>
            <p class="text-xs text-gray-400 mt-0.5">Messages from {{ tenantName }}</p>
        </div>
        ...
        <div v-if="loading" class="space-y-3">
            <div v-for="i in 4" :key="i" class="bg-white rounded-3xl p-5 animate-pulse">
                <div class="flex gap-3">
                    <div class="w-9 h-9 rounded-2xl bg-gray-100 flex-shrink-0"></div>
                    <div class="flex-1">
                        <div class="h-3 bg-gray-100 rounded-full w-2/5 mb-3"></div>
            ...
            <div v-else-if="upcomingEvents.length" class="space-y-3">
                ...
                >
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500 mt-1">{{ formatEventDate(event.start_datetime) }}</p>
                ...
                >
                    <span v-if="loadingMoreEvents" class="flex items-center justify-center gap-2">
                        <span class="w-4 h-4 border-2 border-gray-300 border-t-gray-700 rounded-full animate-spin"></span>
                        Loading…
                    </span>
        ...
        <template v-if="!loading">
            <div v-if="items.length" class="space-y-3 mb-6">
                ...
                >
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-600 mt-1 leading-relaxed whitespace-pre-line">{{ item.message }}</p>
                            <p class="text-xs text-gray-400 mt-2">{{ formatDate(item.sent_at) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="loadingMore" class="py-4 flex justify-center">
                    <div class="w-5 h-5 border-2 border-gray-200 border-t-gray-800 rounded-full animate-spin"></div>
                </div>
