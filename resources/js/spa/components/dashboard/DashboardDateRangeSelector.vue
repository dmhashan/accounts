<template>
  <div ref="selectorRoot" class="relative w-full sm:w-auto">
    ...
    <div
      v-if="open"
      class="app-surface absolute left-0 top-full z-40 mt-2 w-full min-w-0 rounded-lg border border-secondary-200 p-3 shadow-xl dark:border-secondary-700 sm:left-auto sm:right-0 sm:w-[min(calc(100vw-1.5rem),22rem)]"
    >
