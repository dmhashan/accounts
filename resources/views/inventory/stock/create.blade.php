<x-app-layout>
    <x-slot name="title">Add Stock - {{ app('tenant')->name }}</x-slot>
    ...
    <div class="flex h-screen bg-background-light dark:bg-background-dark">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <x-header>
                <x-slot name="title">Add Stock Entry</x-slot>
            </x-header>
                        ...
                        <form action="{{ route('inventory.stock.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select name="product_variation_id" id="product_variation_id" required
                                        ...
                                        @foreach($variations as $variation)
                                            <option value="{{ $variation->id }}" data-product="{{ $variation->product_id }}" {{ old('product_variation_id') == $variation->id ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="purchasing_price" id="purchasing_price" value="{{ old('purchasing_price') }}" min="0" required
                                        class="w-full px-4 py-2 border border-secondary-300 dark:border-secondary-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-secondary-700 dark:text-white">
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="local_selling_price" id="local_selling_price" value="{{ old('local_selling_price') }}" min="0" required
                                        class="w-full px-4 py-2 border border-secondary-300 dark:border-secondary-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-secondary-700 dark:text-white">
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="foreign_selling_price" id="foreign_selling_price" value="{{ old('foreign_selling_price') }}" min="0" required
                                        class="w-full px-4 py-2 border border-secondary-300 dark:border-secondary-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-secondary-700 dark:text-white">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="manufacturing_date" id="manufacturing_date" value="{{ old('manufacturing_date') }}"
                                        class="w-full px-4 py-2 border border-secondary-300 dark:border-secondary-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-secondary-700 dark:text-white">
                            ...
                            <div class="flex items-center justify-end space-x-4 pt-6">
                                ...
                                <button type="submit" class="px-6 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors">Save Stock</button>
                            </div>
                        </form>
                    </div>
                </div>
