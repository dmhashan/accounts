        ...
        <div class="max-w-md w-full">
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="name" name="name" type="text" required autofocus
                               class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('name') border-red-300 @enderror"
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('login.form') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-colors">
