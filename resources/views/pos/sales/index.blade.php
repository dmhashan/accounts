            ...
            <main class="flex-1 overflow-y-auto p-4 md:p-6">
                ...
                <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
                    <div>
                        ...
                        <p class="text-secondary-600 dark:text-secondary-400">Recent POS transactions.</p>
                    </div>
                    <a href="{{ route('pos.sales.create') }}" class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors">New Sale</a>
                </div>
