    ...
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-white dark:bg-secondary-900 rounded-xl shadow-sm border border-secondary-200 dark:border-secondary-700 p-7">
            <div class="flex items-center justify-between mb-5">
                ...
                <button type="button" id="addItemBtn" class="px-5 py-3 text-base bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors">Add Item</button>
            </div>
        ...
        <div class="bg-white dark:bg-secondary-900 rounded-xl shadow-sm border border-secondary-200 dark:border-secondary-700 p-7">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="totalAmount" class="w-full px-4 py-3 text-base border border-secondary-300 dark:border-secondary-600 rounded-lg bg-secondary-100 dark:bg-secondary-800 text-secondary-900 dark:text-white" value="0.00" readonly>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="balanceAmount" class="w-full px-4 py-3 text-base border border-secondary-300 dark:border-secondary-600 rounded-lg bg-secondary-100 dark:bg-secondary-800 text-secondary-900 dark:text-white" value="0.00" readonly>
                </div>
            </div>
