...
class ConfigurationApiController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'general\.openwa_enabled' => ['sometimes', 'in:0,1'],
            'general\.openwa_url' => ['sometimes', 'nullable', 'string', 'max:500'],
            'general\.openwa_api_key' => ['sometimes', 'nullable', 'string', 'max:255'],
            'general\.openwa_session_id' => ['sometimes', 'nullable', 'string', 'max:255'],
            'general\.openwa_groups' => ['sometimes', 'nullable', 'json'],
