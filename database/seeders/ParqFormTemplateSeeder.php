        ...
        $translations = [
            ...
            'si' => [
                ...
                'fields'      => [
                    ...
                    self::F_PARA_INTRO => ['label' =>
                        'නිතිපතා ශාරීරික ව්‍යායාම ප්‍රීතිමත් හා සෞඛ්‍ය සම්පන්නය. බොහෝ දෙනෙකුට ශාරීරිකව ක්‍රියාශීලී වීම ඉතා ආරක්ෂිතය. කෙසේ නමුත් සමහරෙකු ශාරීරික ක්‍රියාකාරකම් ආරම්භ කිරීමට පෙර වෛද්‍යවරයෙකු හමු විය යුතුය.'
                        . "\n\n"
            ...
            'ta' => [
                ...
                'fields'      => [
                    ...
                    self::F_PARA_INTRO => ['label' =>
                        'தொடர்ந்து உடல் செயல்பாடில் ஈடுபடுவது மகிழ்ச்சியானதும் ஆரோக்கியமானதும் ஆகும். பெரும்பாலானவர்களுக்கு அதிக உடல் செயல்பாடு மிகவும் பாதுகாப்பானது. இருப்பினும், சிலர் உடல் ரீதியாக மிகவும் சுறுசுறுப்பாக மாறுவதற்கு முன்பு மருத்துவரிடம் சோதிக்க வேண்டும்.'
                        . "\n\n"
            ...
            'de' => [
                ...
                'fields'      => [
                    ...
                    self::F_PARA_INTRO => ['label' =>
                        'Regelmäßige körperliche Aktivität macht Spaß und ist gesund. Für die meisten Menschen ist mehr körperliche Aktivität sehr sicher. Einige Personen sollten jedoch vor Beginn einer intensiveren körperlichen Aktivität ihren Arzt konsultieren.'
                        . "\n\n"
            ...
            'es' => [
                ...
                'fields'      => [
                    ...
                    self::F_PARA_INTRO => ['label' =>
                        'La actividad física regular es divertida y saludable, y cada vez más personas comienzan a ser más activas cada día. Ser más activo es muy seguro para la mayoría de las personas. Sin embargo, algunas personas deben consultar a su médico antes de comenzar a ser mucho más activas físicamente.'
                        . "\n\n"
            ...
            'pt' => [
                ...
                'fields'      => [
                    ...
                    self::F_PARA_INTRO => ['label' =>
                        'A atividade física regular é divertida e saudável, e cada vez mais pessoas estão se tornando mais ativas. Ser mais ativo é muito seguro para a maioria das pessoas. No entanto, algumas pessoas devem consultar seu médico antes de se tornarem muito mais ativas fisicamente.'
                        . "\n\n"
            ...
            'zh' => [
                ...
                'fields'      => [
                    ...
                    self::F_PARA_INTRO => ['label' =>
                        '定期进行体育锻炼既有趣又健康，越来越多的人每天都在变得更加活跃。对大多数人来说，更加活跃非常安全。但是，有些人在开始大量增加体育活动之前应该咨询医生。'
                        . "\n\n"
            ...
            'ja' => [
                ...
                'fields'      => [
                    ...
                    self::F_PARA_INTRO => ['label' =>
                        '定期的な身体活動は楽しく健康的であり、毎日より多くの人々が活動的になり始めています。より活動的になることはほとんどの人にとって非常に安全です。しかし、身体活動を大幅に増やし始める前に医師に確認すべき人もいます。'
                        . "\n\n"
            ...
            'ar' => [
                ...
                'fields'      => [
                    ...
                    self::F_PARA_INTRO => ['label' =>
                        'النشاط البدني المنتظم ممتع وصحي، ويبدأ المزيد من الناس كل يوم في أن يصبحوا أكثر نشاطًا. يُعد النشاط البدني الأكبر آمنًا جدًا لمعظم الناس. ومع ذلك، يجب على بعض الأشخاص استشارة طبيبهم قبل البدء في ممارسة نشاط بدني أكثر بكثير.'
                        . "\n\n"
